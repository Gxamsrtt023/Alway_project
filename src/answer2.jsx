...
const Answer2 = () => {
    ...
    return (
        <div className="container_ANS2">
             <img src="/บ้านans2.png" alt="Body shape illustration" onClick={()=>navigate("/")} className="homeANS2"/>
            ...
            <div className="headerANS2">
                ...
                <div className="description2_ANS2">
                    ...
                    <img src="/รูปร่างสามเหลี่ยมคว่ำ.png" alt="Standard shirt 1" className="IMGAns2"/>
                    <div class="line_ANS2"></div>
                    <p>คุณมีไหล่ที่สวยงามและร่างกายที่ดูแข็งแรงมั่นคง เคล็ดลับการแต่งตัวของเรา
                        จะช่วยให้คุณดูมีเสน่ห์ยิ่งขึ้น มาสร้างความสมดุลให้ร่างกาย</p>
                </div>
            </div>
            </div>
            <div class="line_ANS2_2"></div>
